...
### [1] [Two Fault Lines: Latent Polarity Geometry in X Community Notes](https://arxiv.org/abs/2609.21496)
...
### [2] [Setting the clock: Evaluating temporal window parameters for coordinated behavior detection](https://arxiv.org/abs/2609.21959)
...
### [3] [Auditing bipartite motif interpretations: a worked example with conservation checks and open-path decomposition](https://arxiv.org/abs/2609.22014)
*Tengfei Shao*
...
### [4] [Bootstrapping Disordered Quantum Systems](https://arxiv.org/abs/2609.20916)
...
### [5] [Shape Deformation and Braid Statistics of Fractional Quantum Hall Quasiparticles](https://arxiv.org/abs/2609.20985)
...
### [6] [Resonant spin mode from retarded relaxation](https://arxiv.org/abs/2609.21623)
*J. Beater,G. S. Uhrig*
...
### [7] [Reformulating Pfaffian Quantum Monte Carlo with the Hybrid Monte Carlo formalism](https://arxiv.org/abs/2609.21631)
...
### [8] [Orbital character and photoemission signatures of the A-pocket in infinite-layer nickelates](https://arxiv.org/abs/2609.21665)
...
### [9] [Machine learning magnetic interactions from neutron powder diffraction data](https://arxiv.org/abs/2609.21970)
...
### [10] [Unified Field Bosonization Technique for strongly inhomogenous Luttinger Liquids](https://arxiv.org/abs/2609.21973)
...
### [11] [Correlation enhanced magnetism at a superconducting cuprate/manganite interface](https://arxiv.org/abs/2609.22051)
...
### [12] [Efficient simulation schemes for pricing options under the Ornstein--Uhlenbeck driven stochastic volatility model](https://arxiv.org/abs/2609.21291)
...
### [13] [Simulation of stochastic volatility models via operator splitting schemes](https://arxiv.org/abs/2609.21301)
...
### [14] [Identification problem and quasi-maximum likelihood estimation for matrix-variate CP-factor models](https://arxiv.org/abs/2609.20910)
...
### [15] [Aggregated Posterior Predictive Checks for Generative Modeling](https://arxiv.org/abs/2609.20999)
...
### [16] [A New Generalized Birnbaum-Saunders Regression Model: Inference, Diagnostics, and Applications](https://arxiv.org/abs/2609.21063)
...
### [17] [Bayesian additive regression trees for evaluating treatment benefit predictors using observational data](https://arxiv.org/abs/2609.21097)
...
### [18] [A Partial Fay-Herriot model for Small Area Estimation: Estimating district-level consumption in Mozambique](https://arxiv.org/abs/2609.21701)
...
### [19] [Where quantum and quantum-like methods earn their place in behavioural-trial analysis: three simulation pilots across the RCT pipeline](https://arxiv.org/abs/2609.21269)
...
### [20] [Optimal study interior partitioning (OSIP): An optimization approach to observational study design under fine balance constraints](https://arxiv.org/abs/2609.21902)
*Ron Adar,Asaf Levin*
...
### [21] [Asymptotic Anytime-Valid Quantile Inference under Local Differential Privacy](https://arxiv.org/abs/2609.21338)
...
### [22] [Consistency of Optimal Matching-based Clustering for Mixtures of Markov Chains](https://arxiv.org/abs/2609.21985)
*Ottavio Khalifa*
...
### [23] [Robust Dual-Regularized Variable Selection under Outlier Contamination](https://arxiv.org/abs/2609.21342)
...
### [24] [Robust tests for log-normal lifetimes under cyclic-stress accelerated tests and interval monitoring](https://arxiv.org/abs/2609.21434)
...
### [25] [Estimating heterogeneous treatment effects from randomised trials: a comparison of the risk modelling and treatment effect modelling approaches](https://arxiv.org/abs/2609.21526)
...
### [26] [Fuzzy entropic triple k-means](https://arxiv.org/abs/2609.21538)
...
### [27] [Model-based estimation and imputation with torus missing values](https://arxiv.org/abs/2609.21549)
...
### [28] [Phasing out Monte Carlo: exact acceptance probabilities for mean-spread release rules](https://arxiv.org/abs/2609.21577)
*Remus Osan*
...
### [29] [Testing Conditional Stochastic Dominance via Copula Derivatives](https://arxiv.org/abs/2609.21622)
...
### [30] [Integrating Multivariate Adaptive Regression Splines into Small Area Estimation for Nonlinear Poverty Modeling in Java Island](https://arxiv.org/abs/2609.21987)
...
### [31] [A Novel Convolution-Based Stratified Attribute Estimator for QRE Determination in R&D Tax Credit Studies](https://arxiv.org/abs/2609.21998)
...
### [32] [RKHS-Based Inference for Nonlinear Granger Causality via Conditional Centering](https://arxiv.org/abs/2609.22007)
...
### [33] [UCQM: A Six-Metric Quality Framework for Continuous-Variable Cluster States](https://arxiv.org/abs/2609.20852)
*Saman Sarshar*
...
### [34] [ReFINE: Scheduling of Distillation and Coding for Rate-Fidelity Tradeoff in Quantum Networks](https://arxiv.org/abs/2609.21152)
...
### [35] [Set-Packing and Sequence-Pair QUBOs for the 2D Cutting Stock Problem on Quantum Annealing Hardware](https://arxiv.org/abs/2609.20853)
...
### [36] [Oracle Synthesis Based on X-Map Decision Diagrams](https://arxiv.org/abs/2609.20854)
...
### [37] [Pauli-string grouping for VQE measurement reduction on a sparse-connectivity quantum annealer](https://arxiv.org/abs/2609.20861)
...
### [38] [Stabilizer-Public-Key Authentication: Partial Prediction Bounds and Limits of Key Reuse](https://arxiv.org/abs/2609.20877)
...
### [39] [Nonlocal Magic Spreading in Many-body Quantum Dynamics: From Chaotic Evolution to Quasi-particle Picture in Integrable Models](https://arxiv.org/abs/2609.20951)
...
### [40] [Robust many-body quantum batteries](https://arxiv.org/abs/2609.20966)
...
### [41] [Autonomous stabilization of many-body entanglement with Floquet Hamiltonians and weak measurement](https://arxiv.org/abs/2609.21086)
...
### [42] [Hybrid quantum-classical attention for histopathology-based molecular profiling in data-limited cancers](https://arxiv.org/abs/2609.21115)
...
### [43] [Shock-Capturing Quantum Algorithm for the Linear Advection Operator](https://arxiv.org/abs/2609.21153)
...
### [44] [Multiscale Schmidt-Spectrum Bounds for High-Dimensional Entanglement: Geometric Measures and Schmidt-Number Witnesses](https://arxiv.org/abs/2609.21209)
...
### [45] [Unconditional quantum advantage from a two-round CHSH problem in one dimension](https://arxiv.org/abs/2609.21237)
...
### [46] [Semiclassical Arrhenius law for quantum-thermal escape rates](https://arxiv.org/abs/2609.21625)
...
### [47] [From Trainability Diagnostics to Optimization Claims: Boundaries and Controls in Variational Quantum Optimization](https://arxiv.org/abs/2609.21243)
*Pilsung Kang*
...
### [48] [The Pinnacle Architecture with fixed connectivity of degree eight](https://arxiv.org/abs/2609.21249)
...
### [49] [Pair density Shannon information measures and their $N$-dependent behaviour in diatomic molecular systems](https://arxiv.org/abs/2609.21260)
...
### [50] [Commutator Geometry and Information Preservation in the Quantum Switch](https://arxiv.org/abs/2609.21310)
*Xu Chen,Xue Ma*
...
### [51] [Weighted Berry curvature and global geometry of mixed quantum states](https://arxiv.org/abs/2609.21355)
...
### [52] [Passive Pauli Toggling of Polarization Qubits in Optical Fibers: Error Bounds and QKD Performance](https://arxiv.org/abs/2609.21373)
...
### [53] [Denser Planar Color Codes](https://arxiv.org/abs/2609.21376)
*Noah Shutty*
...
### [54] [A memory-information window in finite-duration quantum control](https://arxiv.org/abs/2609.21380)
*Doyeol,Ahn*
...
### [55] [Ultimate Information Rate for Quantum Sensing under Multilevel Relaxation](https://arxiv.org/abs/2609.21418)
...
### [56] [Polariton Bell Node for Quantum Repeaters](https://arxiv.org/abs/2609.21428)
...
### [57] [Quantum Loads and the Generalized Telegrapher's Problem](https://arxiv.org/abs/2609.21463)
*E. Collin,A. Delattre*
...
### [58] [Optimal control for duty-cycle-limited interferometry with single-NV centers](https://arxiv.org/abs/2609.21501)
...
### [59] [Quantum states with the same entanglement and local unitary equivalence](https://arxiv.org/abs/2609.21558)
*Julio I. de Vicente*
...
### [60] [Giant-Atom-Induced High-Order Output Zeros in a Coupled-Cavity Array](https://arxiv.org/abs/2609.21560)
...
### [61] [Weighted Quantum Signal Processing: Low-Depth Polynomial Approximation with Applications to Kolmogorov-Arnold Networks](https://arxiv.org/abs/2609.21567)
...
### [62] [Global Entanglement Quantification via Classical Shadows](https://arxiv.org/abs/2609.21579)
...
### [63] [Experimental Measurement and Theoretical Analysis of Energy Relaxation Rates of an Interacting Two-Qubit System on a D-Wave Quantum Annealer](https://arxiv.org/abs/2609.21598)
...
### [64] [Time rescaling for second-order feedback-based quantum optimization](https://arxiv.org/abs/2609.21640)
...
### [65] [Floquet physics from quantized light-matter interaction: geometric phases, gauge consistency, and entanglement](https://arxiv.org/abs/2609.21741)
...
### [66] [Intrinsic Vectorial Gradiometry via Quantum Control of a Spin-based Sensor](https://arxiv.org/abs/2609.21776)
...
### [67] [Parameter-Decoupled Quantum Superresolution without Multiparameter Estimation](https://arxiv.org/abs/2609.21796)
*X. -F. Qian*
...
### [68] [Sine-Gordon Model with Bosonic Tensor Networks: Continuum Matching and Soliton Scattering](https://arxiv.org/abs/2609.21846)
...
### [69] [Uhlmann Geometry of Fixed-Rank Density Matrices: A Fiber-Bundle Approach](https://arxiv.org/abs/2609.21875)
*Xu-Yang Hou,Hao Guo*
...
### [70] [Ensemble Dependence of the Critical Exponent at a Quantum Error Correction Threshold](https://arxiv.org/abs/2609.21886)
...
### [71] [The Quantum KKL Inequality](https://arxiv.org/abs/2609.21900)
...
### [72] [Asymptotics for Frequency Redundancies in Quantum Machine Learning Models](https://arxiv.org/abs/2609.21916)
...
### [73] [Guiding Agents of Quantum Games to Equilibrium using Matrix Exponential Fixed-Point Iteration](https://arxiv.org/abs/2609.21944)
...
### [74] [Single-atom-based asynchronous photonic interconnect for scalable modular quantum computing](https://arxiv.org/abs/2609.21961)
...
### [75] [Microwave dielectric properties of LiNbO$_{\mathbf{3}}$ and AlN at millikelvin temperatures and single-photon power](https://arxiv.org/abs/2609.22002)
...
### [76] [Selection rules for pinned and quasipinned occupation numbers with degeneracy](https://arxiv.org/abs/2609.22010)
*Robin Reuvers*
...
### [77] [Cavity-QED analysis of InAs quantum-dot single photon production](https://arxiv.org/abs/2609.22025)
...
### [78] [Persistent Quantum-Enhanced Frequency Sensing with T^{-3/2} Scaling](https://arxiv.org/abs/2609.22046)
...
### [79] [Asymmetric quantum cloning on orthogonal orbits and four-mode fermionic states](https://arxiv.org/abs/2609.22047)
...
### [80] [Warp-Geo: Differentiable Geometry Representation for Dynamic-Boundary Simulation and Shape Optimization](https://arxiv.org/abs/2609.20964)
...
### [81] [Fundamental Bounds on the Polarizability of Macroscopic Scatterers](https://arxiv.org/abs/2609.21248)
...
### [82] [Perspective on Magnetic Nanoparticle Modeling: Interactions, Timescales and Regimes](https://arxiv.org/abs/2609.21671)
...
### [83] [Dirac Cones in d-wave Altermagnets Enable High-Conductivity and High-Efficiency Spin Sources](https://arxiv.org/abs/2609.21766)
...
### [84] [Multilayer Analysis of the Global Trade Network](https://arxiv.org/abs/2609.21614)
...
### [85] [Detectability limits of scaling laws](https://arxiv.org/abs/2609.21638)
*Alec Kirkley*
...
### [86] [Source--Grid Coupling in Power System Oscillations: Observational Equivalence, Feedback Detectability, and Modal Interaction](https://arxiv.org/abs/2609.20943)
*Kai Sun,Bin Wang*
...
### [87] [Optimal Day-Ahead Scheduling of Fast EV Charging Station With Multi-Stage Battery Degradation Model](https://arxiv.org/abs/2609.20946)
...
### [88] [Incremental Stability and Convergence Properties of Discrete-Time Projected Control Systems](https://arxiv.org/abs/2609.20955)
...
### [89] [A Mean-Field Approach for Safe Routing of Multi-Destination Urban Air Mobility Networks](https://arxiv.org/abs/2609.21093)
...
### [90] [Distribution-Free Budgeted Stealthy Attack Scheduling for Remote State Estimation](https://arxiv.org/abs/2609.21148)
...
### [91] [Stochastic MPC under Heavy-Tailed Disturbances: An Extreme Value Theory Approach](https://arxiv.org/abs/2609.21170)
...
### [92] [Minimizing Bid Cost Recovery for Energy Storage with Uniform Pricing](https://arxiv.org/abs/2609.21230)
...
### [93] [Optimal Regret for Online Storage Control via Cumulative Policies](https://arxiv.org/abs/2609.21262)
...
### [94] [Rate-cost Trade-offs in H-infinity Control with Initial State Uncertainty](https://arxiv.org/abs/2609.21270)
...
### [95] [A Distributed Step-by-step Finite-time Consensus Design for Heterogeneous Battery Energy Storage Devices with Droop Control](https://arxiv.org/abs/2609.21313)
...
### [96] [Iterative Single-Loop Coordination of Transmission and Distribution Systems and DER Aggregators with Limited Information Sharing](https://arxiv.org/abs/2609.21435)
...
### [97] [Model-Free Control for Residential Heating: Deployment and Simulation of Nonlinear Data-Enabled Predictive Control](https://arxiv.org/abs/2609.21500)
...
### [98] [Response Time Stochastic Analysis for Fixed-Priority Stable Real-Time Systems](https://arxiv.org/abs/2609.21760)
...
### [99] [Adaptive Uncertainty-Aware Modeling and Stochastic Radial Basis Function Predictive Control for Personalized Fluid Resuscitation](https://arxiv.org/abs/2609.21821)
...
### [100] [Distributed Multiconsensus Control of BESSs Based on Centrality of Eigenvectors](https://arxiv.org/abs/2609.21856)
...
### [101] [Improved Droop Control in DC Microgrids via Voltage-Locked Loop Synchronization](https://arxiv.org/abs/2609.21913)
...
### [102] [Decentralized Continuification Control of Multi-Agent Systems via Distributed Density Estimation](https://arxiv.org/abs/2503.14119)
...
### [103] [Interconnections of Dissipative Networks Through a Dynamic Scattering Controller](https://arxiv.org/abs/2609.21934)
*Ilia G. Polushin*
...
### [104] [Semi-discrete Optimal Transport for Time-Varying Multi-Agent Coverage Control](https://arxiv.org/abs/2601.21753)
...
### [105] [Multi-Agent Event-Triggered LQG Control under Shared Communication Constraints](https://arxiv.org/abs/2609.21974)
...
### [106] [Robust Macroscopic Density Control of Heterogeneous Multi-Agent Systems](https://arxiv.org/abs/2602.09695)
...
### [107] [Learning-Based Augmentation and Adaptation for Grid Sim-to-Real Model Discrepancy](https://arxiv.org/abs/2609.21986)
...
### [108] [Robust multi-scale leader-follower control of large multi-agent systems](https://arxiv.org/abs/2603.16680)
...
### [109] [Internal-Model-Control-Based Virtual Admittance Emulation for Enhanced Grid-Forming Performance](https://arxiv.org/abs/2609.22037)
...
### [110] [Leader-Follower Density Control of Multi-Agent Systems with Interacting Followers: Feasibility and Convergence Analysis](https://arxiv.org/abs/2604.11353)
*Beniamino Di Lorenzo,Gian Carlo Maffettone,Mario di Bernardo*
...
### [111] [Entropy-Regularized Optimal Transport for Time-Varying Multi-Agent Coverage Control](https://arxiv.org/abs/2609.09829)
*Italo Napolitano,Mario di Bernardo*
...
### [112] [Local Detailed Balance in the Lorenz Model: Replaces the Butterfly with Frenetic Bursting](https://arxiv.org/abs/2609.21415)
...
### [113] [Bootstrapping Classical Systems with Quenched Disorder](https://arxiv.org/abs/2609.20927)
...
### [114] [Arctic Curves and a Gapped Gas Phase in a Two-Band Free-Fermion Chain](https://arxiv.org/abs/2609.21004)
...
### [115] [Functional Renormalization for Random Matrix Theory: The relational background field method](https://arxiv.org/abs/2609.21031)
...
### [116] [Persistence, resetting, and first-passage times of an active Ornstein--Uhlenbeck particle](https://arxiv.org/abs/2609.21124)
...
### [117] [The charge dependent hard-sphere model: Polycrystals as low-energy configurations](https://arxiv.org/abs/2609.21508)
...
### [118] [Self-avoiding trails in two and three dimensions](https://arxiv.org/abs/2609.21724)
...
### [119] [Full macroscopic thermalization and the formation of Schrödinger's cats by unitary time evolution in the weakly perturbed Ising model - Applications of the Roos-Sugimoto-Teufel-Tumulka-Vogel theory](https://arxiv.org/abs/2609.21757)
*Hal Tasaki*
...
### [120] [Non-negative differential mobility of one-dimensional underdamped Langevin dynamics: Proof via mapping to a marginally stable oscillator](https://arxiv.org/abs/2609.21833)
*Udo Seifert*
...
### [121] [Multi-Resolution Wire-Fencing for Efficient Path Sampling](https://arxiv.org/abs/2609.21897)
...
### [122] [Universal Eigenvector Statistics of Non-Hermitian Random Matrices](https://arxiv.org/abs/2609.22079)
...
### [138] [The Manifold Hypothesis under Unknown Gaussian Noise:Conditional Certificates and Consistent Dimension Estimation](https://arxiv.org/abs/2609.21311)
*U jin Choi*
...
### [139] [Parameter estimation for graphon-interacting particle systems from discrete observations](https://arxiv.org/abs/2609.21710)
...
### [140] [Schedule optimization for tau-leaping in masked discrete diffusion](https://arxiv.org/abs/2609.21960)
...
### [141] [Surface Stokes drift from compact drifting wave buoys](https://arxiv.org/abs/2609.21592)
...
### [142] [Predicting the Elastic Properties of a Cemented Granular Material during Chemical Damage (Debonding)](https://arxiv.org/abs/2609.21410)
...
### [143] [Determination of Physical Height Differences from Time Transfer via the ACES Mission -- A Simulation Study](https://arxiv.org/abs/2609.21786)
...
### [144] [ASTRA: Toward Agentic AI for Intelligent Device-Network-Cloud Synergy in Next-Generation Mobile Communication](https://arxiv.org/abs/2609.21298)
...
### [145] [Backward log orthogonal functions and their approximation theory](https://arxiv.org/abs/2609.20901)
*Mahmoud A. Zaky*
...
### [146] [Uniform Chebyshev asymptotics for repeated-pole rational approximation of the exponential](https://arxiv.org/abs/2609.21028)
...
### [147] [Energy stability and error estimates for a second-order structure-preserving exponential integrator method for smectic-A liquid crystals](https://arxiv.org/abs/2609.21175)
...
### [148] [A Low-rank ADI Algorithm for the Numerical Solution of Large Discrete-time Non-symmetric Algebraic Riccati Equations](https://arxiv.org/abs/2609.21282)
*Umair Zulfiqar*
...
### [149] [Kernel-free Boundary Integral Methods for Allen-Cahn and Cahn-Hilliard Equations on Irregular Domains](https://arxiv.org/abs/2609.21295)
...
### [150] [History-Compatible Energy-Stable Finite Element Schemes for Variable-Density Cahn--Hilliard--Navier--Stokes Flows on Evolving Meshes](https://arxiv.org/abs/2609.21328)
...
### [151] [FrFNO:Injecting the analytic Mittag-Leffler propagator into a resolution-robust neural operator for space-time fractional PDEs](https://arxiv.org/abs/2609.21512)
*Guofei Pang*
...
### [152] [A Priori and A Posteriori Error Estimates for a Crank Nicolson Type Scheme of an Elliptic Problem with Dynamical Boundary Conditions](https://arxiv.org/abs/2609.21524)
...
### [153] [Element-wise Convergence Behavior of Subspace Iteration](https://arxiv.org/abs/2609.21540)
*Mingyang Zhao*
...
### [154] [Integral chemical reaction neural networks](https://arxiv.org/abs/2609.21715)
...
### [155] [Finite Volume Element Method on Curved-Edge Meshes](https://arxiv.org/abs/2609.21719)
...
### [156] [A Second-Order Maximum-Bound-Preserving and Energy-Stable Exponential Time-Differencing Method for Allen--Cahn-Type Gradient Flows](https://arxiv.org/abs/2609.21820)
*Wenshuai Hu,Guanghua Ji,Xiao Li*
...
### [157] [Isogeometric analysis for the Helmholtz transmission eigenvalue problem](https://arxiv.org/abs/2609.21862)
...
### [158] [Tangential stability and fully discrete convergence of the classical BGN scheme for curve shortening flow](https://arxiv.org/abs/2609.21868)
*Qiqi Rao*
...
### [159] [A filtered time stepping scheme for curve shortening flow for open and closed curves](https://arxiv.org/abs/2609.21871)
...
### [160] [High-Moment Stability and Error Analysis of a Fully Discrete LDG-IMEX Method for High Dimensional Nonlinear Stochastic Convection-Diffusion Equations](https://arxiv.org/abs/2609.21920)
...
### [161] [Synthetic Human Mobility Data Generation: A Structured Review of Representations, Methods, and Practical Capabilities](https://arxiv.org/abs/2609.21413)
...
### [162] [TERRA-NG v1.0: Extreme-Scale, GPU-accelerated Mantle Convection](https://arxiv.org/abs/2609.21633)
...
### [163] [The ecological collapse of color: photoreceptor number buys a geometric hue manifold that natural spectra never fill](https://arxiv.org/abs/2609.21965)
*Mohammad Rostami*
