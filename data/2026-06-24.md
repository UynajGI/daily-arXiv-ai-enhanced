...
TL;DR: 提出了一种数据驱动的方法，利用值函数的梯度和Hessian信息，在非线性控制仿射动力系统中逼近最优控制问题的价值函数，显著降低了样本复杂度并提高了近似精度。


<details>
  <summary>Details</summary>
Motivation: 为了在高维非线性最优控制问题中高效、准确地逼近价值函数，减少对大量训练数据的依赖。

Method: 基于Pontryagin最大值原理生成包含值、梯度和Hessian的数据，结合稀疏多项式基上的加权最小二乘回归，并利用Hessian信息降低样本复杂度；采用双曲交叉索引集和部分Hessian策略以应对高维问题。

Result: 该方法在状态维度递增的问题上验证有效，相比低阶方法最多减少了约一个数量级的训练样本需求，同时提升了近似精度和闭环控制性能。

Conclusion: 引入梯度和Hessian信息进行数据增强可显著提升价值函数逼近效率与反馈控制质量，适用于高维非线性最优控制问题。
...
TL;DR: 本文提出了一种用于拟合支持有界的灵活连续单变量Bézier分布的计算框架，通过一阶优化方法实现了比传统无导数方法快三到四个数量级的拟合速度，并开发了开源Python工具包bezierv以促进理论与实践的结合。


<details>
  <summary>Details</summary>
Motivation: 由于缺乏高效的拟合算法和现代软件实现，尽管Bézier分布在建模复杂形状方面具有潜力，但其在随机模拟和决策分析中的应用受到限制。

Method: 采用最小误差和最大似然估计方法，利用一阶优化算法并结合参数空间几何特性进行分布拟合；设计了基于等张回归的凸约束和高效投影算子。

Result: 所提方法比传统无导数方法快三到四个数量级，在真实数据上具有一致性；相比非线性求解器IPOPT平均快三个数量级且更鲁棒，同时保持相当的精度。

Conclusion: 该研究为Bézier分布提供了高效、可靠的拟合框架，并通过开源工具包bezierv推动其在实际问题中的广泛应用。
...
TL;DR: 提出了一种约束变量投影框架，用于数据科学模型中的双层优化问题，通过自动微分兼容的约简梯度公式和条件梯度算法提升计算与数据效率。


<details>
  <summary>Details</summary>
Motivation: 为解决可分离非线性最小二乘问题中带凸约束的数据科学模型优化效率低的问题，扩展传统变量投影方法。

Method: 将变量投影解释为双层优化问题，推导出与自动微分兼容的精确约简梯度公式，并设计基于条件梯度法的优化算法处理约束下的约简问题。

Result: 在稀疏自编码、字典学习、盲解卷积和少样本学习等任务上验证了该方法相比联合优化基线能提高壁钟时间和数据利用效率。

Conclusion: 所提约束变量投影框架有效提升了多类数据科学模型的优化效率，具备良好的收敛性与应用潜力。
...
### [18] [Fermi surface change and $d$-wave superconductivity in the square lattice Kondo-Heisenberg model](https://arxiv.org/abs/2606.23799)
*Alexander Nikolaenko,Riccardo Rende,Luciano Loris Viteritti,Subir Sachdev,Ya-Hui Zhang*

Main category: cond-mat.str-el

TL;DR: 研究了非半满的二维Kondo-Heisenberg模型，发现弱耦合下存在反铁磁Néel序，强耦合下形成重费米液体，中间区域出现d波超导，表明费米体积变化和非常规超导是该模型的固有特性。


<details>
  <summary>Details</summary>
Motivation: 探索二维Kondo-Heisenberg模型在不同耦合强度下的基态相图，理解费米表面演化与非常规超导的起源。

Method: 使用神经网络量子态方法对平方晶格上的二维Kondo-Heisenberg模型进行研究，调节Kondo和Heisenberg耦合强度以绘制基态相图。

Result: 发现弱Kondo耦合下存在反铁磁Néel序且费米面仅包含导电电子；强耦合下形成重费米液体，费米面包含导电电子和自旋；在交叉区域观察到d_{x^2-y^2}波超导，表现为配对关联的长程有序和共存的配对振幅穹顶。

Conclusion: 费米体积的变化和非常规超导是二维Kondo-Heisenberg模型的内在特征。
...
### [19] [Domain-wall drift in a ferrimagnet induced by a linearly oscillating in-plane magnetic field](https://arxiv.org/abs/2606.23831)
*Murod Mirzhalilov,Jacob Freyermuth*

Main category: cond-mat.str-el

TL;DR: 本文研究了在交变平面内磁场下铁磁体中的畴壁动力学，提出了包含惯性效应的集体坐标模型，并揭示了频率控制的畴壁定向运动机制。


<details>
  <summary>Details</summary>
Motivation: 探索铁磁体中畴壁在交变磁场下的动力学行为，特别是惯性效应对畴壁运动的影响。

Method: 基于保留场依赖动能项的铁磁拉格朗日量，推导出描述畴壁位置与方位角的集体坐标方程，并结合微磁模拟验证理论预测。

Result: 发现交变平面场结合弱静态偏置场可实现角度周期切换向有限平均速度的整流效应；低频时漂移速度正比于频率，高频时运动被抑制，且漂移的大小和方向可通过净自旋密度调控。

Conclusion: 线性振荡磁场可作为实现频率可控畴壁运动的有效机制，凸显了磁补偿附近惯性自旋动力学的重要作用。
...
### [20] [Density-wave order enhances the phonon thermal Hall effect in a trilayer nickelate](https://arxiv.org/abs/2606.24125)
*Qiaochao Xiang,Enkang Zhang,Xiaokang Li,Xiaodong Guo,Mengfei Zhu,Jun Zhao,Guang-Ming Zhang,Liang Li,Zengwei Zhu*

Main category: cond-mat.str-el

TL;DR: 在三重层镍酸盐La4Ni3O10中观察到有限的声子热霍尔效应，其热霍尔响应在密度波转变温度以下显著增强，并表现出两个明显的平台。热霍尔响应与磁振子-声子杂化密切相关，揭示了镍酸盐中晶格和自旋激发之间的相互作用。


<details>
  <summary>Details</summary>
Motivation: 探索 Ruddlesden-Popper 镍酸盐中晶格自由度在其关联正常态中的作用，尤其是高温超导性背景下尚未充分研究的问题。

Method: 通过测量常压下三重层镍酸盐La4Ni3O10的声子热霍尔效应，分析其在密度波转变温度以下的热霍尔响应特征。

Result: 在约140 K的密度波转变温度以下，观察到热霍尔响应显著增强，并出现两个不同的平台；提取的特征能量尺度（~4.1 meV）与磁振子-声子交叉能量（~3.2 meV）相近，表明磁振子-声子杂化是增强热霍尔效应的主要机制。

Conclusion: 磁振子-声子杂化在镍酸盐材料的热输运中起关键作用，这为理解其超导性和绝缘体热霍尔信号的多重起源提供了新视角。
...
### [21] [Fluctuation exchange study on the electron-hole asymmetry of the superconductivity across 1/3 filling in the trilayer Hubbard model](https://arxiv.org/abs/2606.24126)
*Yushi Yamada,Masataka Kakoi,Masayuki Ochi,Kazuhiko Kuroki*

Main category: cond-mat.str-el

TL;DR: 研究了在涨落交换近似下的三层Hubbard模型，发现当 onsite $U$ 较大时，超导性在空穴掺杂区域更显著，归因于能带的非对称重整化。


<details>
  <summary>Details</summary>
Motivation: 探索在接近1/3填充时三层Hubbard模型中的超导行为及其对称性变化。

Method: 采用涨落交换近似方法分析三层Hubbard模型，并研究不同 onsite $U$ 值下的超导特性。

Result: 小 $U$ 时超导性呈电子-空穴对称，大 $U$ 时在空穴掺杂区域更有利于超导。

Conclusion: 大 $U$ 导致成键、非键和反键能带的非对称重整化，从而引起超导性的不对称行为。
...
### [22] [Magnetoelectric flat band induced by a $\sqrt{3}\times\sqrt{3}$ charge density wave in monolayer CrSe$_2$](https://arxiv.org/abs/2606.24494)
...
### [23] [On Degeneracies of Density, Magnetic, and Pairing Responses: How Competing Orders Echo Underlying Symmetries in the Hubbard Model](https://arxiv.org/abs/2606.24755)
...
### [24] [The Interplay of Thermal Melting and Pump Driven Melting of Charge Order: A Two-Temperature Study of the Holstein Model](https://arxiv.org/abs/2606.24800)
...
### [25] [Introduction to matrix-product states and tensor networks](https://arxiv.org/abs/2606.24803)
*Grégoire Misguich*
...
### [26] [THz-induced phonon mode mixing and collective dynamics in a polar nanolattice](https://arxiv.org/abs/2606.24804)
...
### [27] [Suppressing Spontaneous Droplet Shrinkage in Cahn-Hilliard-Stokes Microflows](https://arxiv.org/abs/2606.24295)
*A. M. Gurin*

Main category: physics.geo-ph

TL;DR: 提出了一种曲率依赖的修正方法，以抑制Cahn-Hilliard模型在模拟非混相两相微流时出现的自发液滴收缩伪影，有效改善了相分数偏差和液滴体积守恒。


<details>
  <summary>Details</summary>
Motivation: Cahn-Hilliard模型在模拟中因能量泛函倾向于减小界面面积，导致相分数偏离物理范围（0和1），产生非物理性的液滴收缩伪影，影响模拟准确性。

Method: 提出一种曲率依赖的修正方法，通过调整双阱势能函数来抵消界面面积减少引起的相分数漂移，并在孤立液滴、多孔介质排水和T型 junction 流动等案例中进行验证。

Result: 该方法显著抑制了相分数的过冲/欠冲现象，提升了液滴体积的守恒性，在多种测试场景中表现出良好的稳定性与准确性。

Conclusion: 所提出的曲率修正方法有效解决了Cahn-Hilliard模型中的非物理性收缩问题，增强了其在复杂两相微流系统中的适用性和可靠性。
...
### [28] [Tidal sensitivity of tremors in a mixed fast and slow earthquake system in northeastern Japan](https://arxiv.org/abs/2606.24362)
*Yishuo Zhou,Hideo Aochi,Alexandre Schubnel,Satoshi Ide,Harsha S. Bhat*

Main category: physics.geo-ph

TL;DR: 本研究首次系统探讨了日本东北部俯冲带潮汐对构造震颤的调制作用，发现库页岛海沟南端对潮汐应力最敏感，而日本海沟北部响应最弱，且潮汐敏感性与慢滑移、地震活动及其他应力变化密切相关。


<details>
  <summary>Details</summary>
Motivation: 了解在快慢地震共存的系统中，构造震颤如何响应微小的潮汐应力扰动，从而揭示断层行为及其演化机制。

Method: 利用2016至2024年的震颤目录，分析日本东北部俯冲带不同区域震颤活动对潮汐应力的敏感性，并结合空间分布与时间演变进行统计对比。

Result: 库页岛海沟南端震颤迁移区表现出最强潮汐敏感性且随时间增强，日本海沟北部最弱；低敏感区常伴随较强地震（Mj≥4）和密集震颤活动，表明其他应力扰动可能抑制潮汐影响。

Conclusion: 震颤的潮汐敏感性受慢滑移过程及其他应力变化的影响，可作为探测震源区扰动环境的有效指标，有助于理解复杂地震系统的动态相互作用。
...
### [29] [Offset-continuation-trajectory stacking based on common-reflection-point kinematics for five-dimensional prestack dataset regularization and enhancement](https://arxiv.org/abs/2606.24760)
...
### [30] [Rethinking the green power grid for stability, not just for climate](https://arxiv.org/abs/2606.23805)
*Yiming Wang,Arthur N. Montanari,Adilson E. Motter*

Main category: eess.SY

TL;DR: 可再生能源发电通过合成惯性、先进的逆变器控制和协调的输电规划，不仅能促进脱碳，还能增强电网稳定性。


<details>
  <summary>Details</summary>
Motivation: 2025年伊比利亚大停电事件引发了对高比例可再生能源电网韧性的担忧，促使重新评估可再生能源在电网稳定中的作用。

Method: 通过分析合成惯性、基于先进逆变器的控制策略以及协调输电规划的技术进展，论证可再生能源对电网稳定性的潜在贡献。

Result: 研究表明，储能和电力电子技术的快速发展使可再生能源不仅能够支持脱碳目标，还能提升电网的稳定性与韧性。

Conclusion: 可再生能源结合新兴技术有望在实现低碳化的同时，构建更稳定、更具弹性的未来电力系统。
...
### [31] [DISPCA : A hybrid iterative-sequential approach for the identification of errors-in-variables model of linear DAE systems](https://arxiv.org/abs/2606.23886)
*Deepanjhan Das,Vishwesh Ramanathan,Shankar Narasimhan*

Main category: eess.SY

TL;DR: 提出了一种在误差变量（EIV）环境下从含噪声数据中识别线性微分代数方程（DAE）模型的系统方法，能够自动估计系统动态与代数关系数量、可观测性指数、延迟参数及模型系数。


<details>
  <summary>Details</summary>
Motivation: 现有研究多集中于常微分方程（ODE）系统的建模，而对含有输入输出测量噪声的微分代数方程（DAE）系统辨识研究较少，亟需一种能处理复杂耦合动态与代数约束的自动化辨识方法。

Method: 采用滞后数据矩阵的部分堆叠策略，结合逐步增大的滞后窗口，逐个识别微分关系；通过迭代估计对角异方差的测量误差协方差矩阵，在大样本条件下实现模型参数与结构的联合估计。

Result: 算法可同时确定微分与代数关系的数量、延迟参数、可观测性指数及所有模型系数，无需用户预先设定；仿真研究表明该方法在多种场景下均具有良好的辨识精度和鲁棒性。

Conclusion: 所提方法为线性 descriptor 系统在EIV条件下的数据驱动建模提供了通用且计算可行的框架，显著拓展了现有系统辨识方法的适用范围。
...
### [32] [Welfarist Control Design -- How to fulfill the societal mandate in multi-agent control?](https://arxiv.org/abs/2606.23931)
*Sophie Hall,Kai Zhang,Ilia Shilov,Heinrich H. Nax,Saverio Bolognani*

Main category: eess.SY

TL;DR: 本文探讨了控制工程师如何通过三种控制设计范式，将个体偏好聚合到系统目标中，并利用反馈机制实现稀缺资源的公平高效分配。


<details>
  <summary>Details</summary>
Motivation: 随着社会技术系统中资源分配过程的自动化，控制工程师需要做出符合社会期望的设计决策，但目前的设计多依赖行业惯例而非伦理和责任考量，因此需要更原则性的设计方法。

Method: 研究了在线反馈优化、马尔可夫决策过程控制和模型预测控制三种控制设计范式，提出通过聚合个体偏好形成控制目标，并利用反馈机制确保目标的实现与验证。

Result: 论证了控制系统中的反馈机制能够以前所未有的方式实现共享资源的适当分配，提升了资源分配的透明性、公平性和可认证性。

Conclusion: 反馈控制为满足社会授权提供了有力工具，控制设计应从依赖惯例转向以社会责任为导向的 principled 设计范式。
...
### [33] [Flow-Corrected Thompson Sampling for Non-Stationary Contextual Bandits](https://arxiv.org/abs/2606.23933)
...
### [34] [Resilient Substation Design for 500 Year Storm Events Current State of the Art and Challenges for Floodplain Management and Infrastructure Hardening](https://arxiv.org/abs/2606.24065)
...
### [35] [Safe Packetized Control for Stochastic Constrained Networked Systems](https://arxiv.org/abs/2606.24148)
...
### [36] [From Stabilizing Regions to Certified Controllers: Closing the Selection Gap in Unified PID/PI Analysis for Time-Delay Plants](https://arxiv.org/abs/2606.24202)
*Senol Gulgonul*
...
### [37] [Control Based Enhanced Regenerative Modes for Hydraulic Multi-Actuator Systems](https://arxiv.org/abs/2606.24284)
...
### [38] [Data-Driven Robust MPC for Unknown Nonlinear Systems via Set-Membership Learning](https://arxiv.org/abs/2606.24316)
...
### [39] [An Integer Linear Programming Approach for Maximum Power Extraction from Solar PV Plants under Partial Shading](https://arxiv.org/abs/2606.24342)
...
### [40] [Multiplayer Reach-Avoid Differential Games with Defender-Side Information Delay](https://arxiv.org/abs/2606.24542)
...
### [41] [CONDUCTOR: An LLM-Orchestrated Digital Twin for Uncertainty-Aware Distribution Grid Operations](https://arxiv.org/abs/2606.24609)
...
### [42] [Human-Robot Shared Control for Humanized End-Effector Teleoperation](https://arxiv.org/abs/2606.24629)
...
### [43] [Multi-Worker Assembly Line Rebalancing with Relevance-Guided Configuration Preservation](https://arxiv.org/abs/2606.24680)
...
### [44] [Efficient implementation of graph autoencoders for model-order reduction of systems with sharp gradients](https://arxiv.org/abs/2606.23834)
*Liam K Magargal,Parisa Khodabakhshi*

Main category: cs.CE

TL;DR: 本研究提出了一种基于图自编码器的模型降阶方法GNN-LaSDI，用于高维动力系统的非线性降维，尤其适用于具有陡峭梯度的系统。相比传统POD方法，GNN-LaSDI在精度上显著提升，并引入新的点云误差指标来评估陡梯区域的准确性。


<details>
  <summary>Details</summary>
Motivation: 传统的线性降维方法（如POD）在处理具有陡峭梯度的高维动力系统时表现不佳，难以捕捉非线性特征，因此需要一种更有效的非线性降维框架。

Method: 提出GNN-LaSDI框架，结合图自编码器进行非线性降维，并利用算子学习方法直接逼近潜在空间的时间演化；同时设计一种新的点云误差指标来评估陡梯位置的预测精度。

Result: 在两个具有陡梯的数值实验中，GNN-LaSDI比POD-LaSDI精度更高，计算成本低于GD-LSPG但略高于POD-LaSDI；新提出的点云误差指标能更直观地反映局部误差。

Conclusion: GNN-LaSDI在计算效率与预测精度之间取得了良好平衡，特别适合处理含强非线性特征的系统，且新误差指标为评估降阶模型在关键区域的表现提供了更优手段。
...
### [45] [Neural Network-Based Parametric Model Reduction for Predicting Turbulent Flow for Different Vehicle Geometries](https://arxiv.org/abs/2606.24265)
*Kazuto Ando,Rahul Bale,Akiyoshi Kuroda,Makoto Tsubokura*

Main category: cs.CE

TL;DR: 本研究扩展了基于神经网络的模型降阶方法，引入变分自编码器以提高在高雷诺数、多车身几何形状下的流动模拟鲁棒性，重点关注车辆尾部区域涡旋生成的多尺度重构精度。


<details>
  <summary>Details</summary>
Motivation: 工业应用中的数值模拟常受限于计算资源，需在保证精度的同时降低计算成本。传统方法难以有效处理高维、非线性流动场，尤其在复杂几何和高雷诺数条件下，因此需要更鲁棒的降阶模型。

Method: 采用基于变分自编码器的非线性降维方法，将高分辨率流场数据映射到紧凑的潜在空间，并结合时间演化方法与分布式并行训练框架，实现对多车身、变几何条件下高雷诺数流动的有效建模与重建。

Result: 所提方法在不同空间和时间尺度上实现了对涡旋生成的高精度重构，尤其在车辆尾部复杂流动区域表现出良好的鲁棒性和压缩效率。

Conclusion: 引入变分自编码器显著提升了模型在复杂工业流动场景下的泛化能力与稳定性，为高精度、低计算成本的工程仿真提供了有效途径。
...
### [46] [A Step Towards Inherently Interpretable Causal Machine Learning Models For Decision Support](https://arxiv.org/abs/2606.24348)
*David Zapata Gonzalez*

Main category: cs.CE

TL;DR: 本文提出将因果机器学习与本质可解释模型结合，用于横截面数据，以提升预测性能、可解释性及what-if分析能力。


<details>
  <summary>Details</summary>
Motivation: 现有机器学习解释方法主要揭示模型如何利用相关性进行预测，但缺乏对因果关系的支持，难以满足需要因果推断的决策需求。

Method: 将因果机器学习方法与本质可解释模型相结合，并在横截面数据上进行评估，兼顾预测准确性与模型可解释性。

Result: 该方法在预测和what-if情景分析中表现良好，同时能清晰揭示变量间的因果关系、系统结构及函数形式。

Conclusion: 该研究推动了因果性、可解释性与数据驱动决策支持的融合，有助于实现更透明、基于因果的智能决策。
...
### [47] [Development of a Programming Based Kinetic Model for Two Stage Composting of Solid Waste](https://arxiv.org/abs/2606.24556)
*Zarif Tanzim Aziz,Md. Mahfuzur Rahman,Quazi Hamidul Bari*

Main category: cs.CE

TL;DR: 提出了一种用户友好的两阶段动力学模型，用于简化堆肥效率分析，促进可持续废物管理。


<details>
  <summary>Details</summary>
Motivation: 传统堆肥过程优化依赖复杂且难以解释的数学模型，需更易用的工具来提升生物降解废物管理的可操作性。

Method: 开发了一个基于编程的两阶段动力学模型，第一阶段涵盖前28天的分解，第二阶段评估后续降解过程。

Result: 该模型简化了堆肥效率分析，使堆肥过程更易于理解和应用。

Conclusion: 该两阶段模型为可持续废物管理提供了一种实用、易用的堆肥优化工具。
...
### [48] [Order restricted estimation of the parameter functions in an additive hazard model](https://arxiv.org/abs/2606.23882)
*Dragi Anevski,ElBatoul Manel Merai*

Main category: math.ST

TL;DR: 本文提出了一种Aalen加性风险回归模型中参数函数的估计方法，通过将普通最小二乘估计得到的朴素估计量投影到单调函数空间，获得了具有n^{-1/3}收敛速度和Chernoff分布极限分布的估计量。


<details>
  <summary>Details</summary>
Motivation: 为了改进Aalen加性风险模型中参数函数的估计效果，克服朴素估计量可能不具备单调性的问题。

Method: 采用个体和分量级的l^2投影方法，将朴素估计量投影到单调函数空间，从而获得更合理的估计结果。

Result: 所提出的估计量在逐点极限分布下表现出n^{-1/3}的收敛速率，并以Chernoff分布作为极限分布。

Conclusion: 该方法有效提升了Aalen加性风险模型中参数函数估计的理论性质，适用于需要单调性约束的情形。
...
### [49] [Explicit confidence bands and intervals for distribution functions and their derivatives via random Weierstrass-type operators](https://arxiv.org/abs/2606.24345)
*José A. Adell,J. T. Alcalá,C. Sangüesa*

Main category: math.ST

TL;DR: 本文通过将经典核估计器解释为随机Weierstrass型算子（特别是随机Steklov算子），建立了分布函数及其导数的显式非渐近置信带和置信区间。


<details>
  <summary>Details</summary>
Motivation: 旨在为分布函数F及其各阶导数F^{(k)}构建精确的非渐近置信带与置信区间，克服传统方法在有限样本下的局限性。

Method: 利用Dvoretzky-Kiefer-Wolfowitz不等式结合次序统计量的集中不等式，以及对估计量均方误差（MSE）的精确估计，处理F^{(k)}具有一阶孤立间断点的情形，并引入中点函数(F^{(k)})_⋆(x)进行估计。

Result: 在仅假设F^{(k)}一致连续的前提下，建立了F^{(k)}的置信带；允许F^{(k)}存在第一类孤立间断点以构造置信区间；置信带与区间的长度依赖于F^{(k)}的光滑性（由二阶连续模度量），当F在局部为至多k+1次多项式时，长度达到n^{-1/2}阶。

Conclusion: 该方法提供了一种适用于广泛分布类别的非渐近推断工具，具有明确的收敛速率和对不连续点的鲁棒性，拓展了经典核估计的理论应用范围。
...
### [50] [Ferguson's Dirichlet Process Breakthrough: A Lasting Legacy](https://arxiv.org/abs/2606.24519)
*Antonio Lijoi,Igor Pruenster,Junyi Zhang*

Main category: math.ST

TL;DR: 本文回顾了Dirichlet过程的三种构造方法，强调其在贝叶斯非参数统计中的核心作用，并建议将其称为Ferguson-Dirichlet过程以纪念Ferguson的贡献。


<details>
  <summary>Details</summary>
Motivation: 为了克服长期以来缺乏可处理的非参数先验的问题，推动贝叶斯非参数统计的发展。

Method: 通过有限维分布、伽马过程归一化以及预测分布三种方式构建Dirichlet过程。

Result: Dirichlet过程成为贝叶斯非参数方法的基石，并启发了更广泛的非参数先验研究。

Conclusion: 应将Dirichlet过程称为Ferguson-Dirichlet过程，以认可Ferguson在解决长期开放问题上的决定性贡献。
...
### [51] [A Concentration Inequality for the Covariance Matrix of an Arbitrary Subset of Random Vectors](https://arxiv.org/abs/2606.24766)
...
### [52] [Strong duality for the GROW criterion](https://arxiv.org/abs/2606.24768)
...
### [53] [Autoregressive Processes on Riemannian Manifolds](https://arxiv.org/abs/2606.24771)
...
### [54] [Characterizing some dynamical states in swarmalators system using recurrence analysis](https://arxiv.org/abs/2606.24518)
*Delors A. Jiofack,Zidane Choffo,Carmel T. Lambu,Sandrine J. Mabekou,Patrick Louodop,Fernando F. Ferreira,Norbert Marwan*

Main category: nlin.AO

TL;DR: 提出了一种基于联合递归图和熵度量的方法，用于识别和表征具有移动性网络中的 chimera 或类 chimera 态。


<details>
  <summary>Details</summary>
Motivation: 在节点因移动性而难以按索引排序的网络中，chimera 态的识别具有挑战性，传统序参量常给出模糊结果。

Method: 基于联合递归图（joint recurrence plots）和熵基度量，引入‘独立性程度’来估计系统中动力学完全独立节点的比例。

Result: 该方法能清晰区分完全同步、准同步和无序状态，并有效识别混沌Colpitts振荡器网络和swarmalators系统中的chimera或类chimera态（如沸腾态）。

Conclusion: 所提方法为存在移动性和延迟相互作用的复杂系统中chimera态的识别与刻画提供了鲁棒且有效的工具。

Abstract: Chimera or chimera-like states arise in a wide variety of networks and their identification remains challenging particularly when mobility prevents index-based ordering of the nodes. In this work, we propose a recurrence analysis based method to identify and characterize chimera states in two distinct dynamical frameworks: a network of chaotic Colpitts oscillators and a system of swarmalators where delayed interactions induce chimera-like dynamics named boiling state. The suggested strategy is based on the joint recurrence plots and entropy-based measures, to capture the spatio-temporal organization. This approach enables a clear discrimination between complete synchronization, quasi-synchronization and disordered regimes, even when conventional order parameters yield ambiguous results. Furthermore, we introduce the degree of independence, which estimates the proportion of dynamically completely independent nodes in the system. This measure provides a robust characterization of transitions between collective states.
...
### [55] [The Physics of Topological Defects in Glasses](https://arxiv.org/abs/2606.24376)
*Arabinda Bera,Peter Schall,Timothy W. Sirk,Vijayakumar Chikkadi,Alessio Zaccone*

Main category: cond-mat.dis-nn

TL;DR: 本文综述了玻璃材料中拓扑缺陷的最新研究进展，探讨其在非晶态固体塑性和力学失效中的微观作用。


<details>
  <summary>Details</summary>
Motivation: 探索非晶态固体中拓扑缺陷在塑性变形和力学行为中的作用，建立统一的拓扑描述框架。

Method: 综述理论、计算和实验研究，分析振动本征模式、非仿射位移场和变形诱导矢量场中的拓扑不变量。

Result: 发现拓扑缺陷与软点、局部塑性重排、屈服和剪切带形成密切相关。

Conclusion: 拓扑缺陷为理解非晶态材料的塑性和机械失效提供了新的视角，未来有望实现统一的拓扑理论描述。
...
### [56] [Anderson localization on the Bethe lattice](https://arxiv.org/abs/2606.24671)
*Dafne Prado Bandeira,Angelica Vecchiarelli,Marco Tarzia*

Main category: cond-mat.dis-nn

TL;DR: 本文综述了Bethe格点上的安德森局域化现象，重点介绍了格林函数和腔方法的形式体系，讨论了局域化的诊断方法及其在格林函数统计特性中的体现，并推导出自洽方程，分析了相变临界行为及相关物理量。


<details>
  <summary>Details</summary>
Motivation: 由于Bethe格点具有指数体积增长特性，可实现安德森问题的无限维极限，为研究无序导致的量子相变提供了可解析处理的独特框架，同时也可用于描述多体构型空间中的局域化行为。

Method: 采用格林函数（即预解子）形式体系和腔方法，通过求解对角预解子的自洽方程，结合数值群体动力学方法和大连接极限下的解析处理，研究局域化相变的性质。

Result: 得到了局域化-离域化相变的临界无序强度、绝缘相中的局域化长度、离域化相中的关联体积等关键物理量，并揭示了局域化转变中局部态密度概率分布作为自然序参量的作用，同时建立了与随机介质中定向聚合物及罕见共振路径之间的联系。

Conclusion: Bethe格点上的安德森局域化可通过腔方法和格林函数统计特性进行系统研究，该框架不仅提供了对相变临界行为的深入理解，还为多体局域化等问题提供了有效的平均场类比模型。
...
### [57] [On the localization transition from MAA to AA models](https://arxiv.org/abs/2606.24720)
*Hangdong Qiu,Yunhua Wang*

Main category: cond-mat.dis-nn

TL;DR: 提出了一种新的双准周期MAA模型（DMAA），揭示了从MAA到AA模型的局域化转变过程，发现了多次局域-非局域相变，并通过数值计算和实验模拟验证了其特征和可行性。


<details>
  <summary>Details</summary>
Motivation: 探究MAA和AA模型之间局域化转变的演化机制，尤其是为何MAA模型存在迁移边而AA模型没有。

Method: 构建包含偶数位点和奇数位点非零势能的双准周期MAA模型（DMAA），并引入可调振幅因子；利用逆参与比、归一化参与比、分形维数和实空间波函数分布进行数值分析，并通过极化激元模式的连续模型模拟验证实验可行性。

Result: 发现DMAA模型中存在多次和多重局域-去局域化转变，超出原有的单一局域化转变；数值结果与连续模型模拟一致，证实该模型具有实验可行性。

Conclusion: DMAA模型为研究两类相似准周期系统之间的局域化转变提供了新框架，拓展了对安德森局域化的理解。
...
### [58] [Recursive behavior in a diatomic FPUT lattice](https://arxiv.org/abs/2606.24280)
*Guo Deng,Andrea Pezzi,Genghong Lin,Miguel Onorato*

Main category: nlin.CD

TL;DR: 研究了具有立方非谐势的双原子FPUT晶格，发现两种类型的递归行为：经典的FPUT递归和由光学-声学模式相互作用引起的新型递归，并通过简化模型和连续极限下的可积PDE系统加以验证。


<details>
  <summary>Details</summary>
Motivation: 探索双原子FPUT晶格中非线性导致的递归现象，特别是单原子情况下无法出现的新类型递归行为。

Method: 分析傅里叶模式间的共振相互作用，构建简化的傅里叶空间动力学模型，并在双原子Toda晶格和颗粒链中进行数值模拟验证；进一步推导连续极限下的耦合PDE系统。

Result: 发现了两种递归类型，证实了光学-声学-声学三模共振的存在，成功复现递归行为，并在不同模型中验证其鲁棒性，最终得到一组可积的耦合偏微分方程。

Conclusion: 双原子FPUT系统中存在由分支间模式相互作用引起的新递归机制，且该行为具有普遍性和可积性潜力。
...
### [60] [Regimes of Influence in Trust-Uncertainty Gated Networks](https://arxiv.org/abs/2606.24095)
*Razieh Masoumi,Ahana Biswas,Yu-Ru Lin*

Main category: physics.soc-ph

TL;DR: 本文提出了一种名为“门控网络可信度”（Gated Network Credence）的模型，用于刻画社交网络中个体对同一信息源同时存在信任与不信任的矛盾心理，并揭示这种情感如何通过设定阈值影响信念传播，发现不同参数下存在四种动态模式，且在特定条件下会出现中心-边缘节点影响力反转的现象。


<details>
  <summary>Details</summary>
Motivation: 传统观点动力学模型通常忽略个体对同一信息源同时存在信任与不信任的现象，本文旨在形式化这种关系中的情感矛盾，并研究其如何调节人际影响过程。

Method: 提出Gated Network Credence模型，为每个有向连接分别编码信任和不信任评估，计算出‘净信任’和‘不确定性’两个指标；仅当净信任超过阈值且不确定性低于另一阈值时，代理人才更新信念，从而形成有效的影响力图；通过扫描两个阈值，识别出四种动态机制，并在合成与真实网络中验证结果。

Result: 发现了四种信念动态模式：多元型、选择型、一致型和强化型；其中在选择型机制中高连接度节点主导影响力，而在一致型机制中由于严格过滤不确定性，高连接度节点的影响通道被大量削弱，导致低连接度的边缘节点反而在集体信念均衡中发挥更大作用，出现中心-边缘反转现象；该结果在多种网络结构中具有一致性。

Conclusion: 信念动态不仅依赖于网络结构，更受到信任与不信任之间矛盾关系如何‘门控’人际影响过程的深刻影响，特别是通过设定接受信息的心理阈值，可导致完全不同的社会共识形态和权力分布格局。
...
### [61] [Do Waders, Swimmers, and Divers Exist? A GPS-Based Pilot Study of Site-Dependent Visitor Movement in Theme Parks](https://arxiv.org/abs/2606.24434)
*Dane M. Utley,Jürgen Hackl*

Main category: physics.soc-ph

TL;DR: 本研究通过GPS追踪和退出调查，分析了游客在不同主题公园中的实际移动行为，发现行为模式是连续的而非离散类别，且具有地点依赖性，自我报告不能准确反映实际行为，行为参数无法跨地点迁移。


<details>
  <summary>Details</summary>
Motivation: 挑战旅游景点中普遍使用的游客行为类型假设，检验这些类型是否真实存在并可跨地点通用。

Method: 使用个体级GPS移动数据和退出调查，在多个不同运营方的主题公园中收集数据；提取可解释的移动特征，采用多标准验证协议进行聚类分析，并通过基于代理的模拟实验探究行为根源。

Result: 行为群体虽可重复识别但无明确边界，表现为连续体；实际行为与自我描述存在偏差；不同园区间移动特征关系反转，表明行为模式具有地点特异性；行为的空间特征源于访问地点及顺序的选择，而非行走速度或路径直接性。

Conclusion: 人类移动行为具有地理情境依赖性，必须在本地校准，不能简单借用其他环境的参数；研究提供了一套可复现的运动数据分割流程，并连接了实证追踪与仿真模型。
...
### [62] [Dimensionality Reduction of QAOA Parameter Space with Kernel PCA for Max-Cut](https://arxiv.org/abs/2606.23718)
*Sidharth Brahmandam,Vayd Ramkumar*

Main category: quant-ph

TL;DR: 本研究提出使用核主成分分析（KPCA）作为量子近似优化算法（QAOA）参数优化的非线性降维方法，相较于传统PCA，在较深电路深度下显著提升了性能，尤其在深度8时KPCA的近似比超过0.86，且两种方法均将量子电路评估次数减少93%以上。


<details>
  <summary>Details</summary>
Motivation: 随着QAOA电路深度增加，优化参数增多，搜索空间变得高度非线性，传统PCA因线性限制在高深度下效果下降，因此需要更有效的非线性降维方法来捕捉参数流形结构。

Method: 采用径向基函数核的核主成分分析（KPCA）对QAOA参数进行非线性降维，并在三种图模型（Erdos-Renyi、Barabasi-Albert、Watts-Strogatz）上训练和测试，使用200个7-10节点的图进行训练，在12节点的30个测试图上评估深度1、2、4、8的性能。

Result: KPCA在所有图家族中均优于PCA，尤其在深度8时表现显著：KPCA近似比高于0.86，而PCA降至0.81–0.83；两种方法都将量子电路评估次数减少超过93%。

Conclusion: 非线性核方法能更有效地捕获QAOA参数流形的结构，KPCA为扩展变分量子优化至更深电路提供了一种可行方案。
...
### [63] [Augmenting Imaginary-Time Evolution with Local Geometric Information](https://arxiv.org/abs/2606.23934)
*Carlos L. Benavides-Riveros,Prachi Sharma,Fedor Šimkovic*

Main category: quant-ph

TL;DR: 提出了一种增强型虚时间演化（AITE）框架，利用能量分布的高阶统计结构实现比标准虚时间演化更快的收敛，具有超线性收敛和有限时间内误差归零的特性。


<details>
  <summary>Details</summary>
Motivation: 标准虚时间演化（ITE）在基态制备中收敛缓慢，仅渐近趋近基态，受能量方差限制，需要更高效的演化方法。

Method: 引入增强型虚时间演化（AITE），基于瞬时能量分布的高阶统计结构，沿局部最优方向进行几何感知的梯度下降。

Result: AITE在整个演化过程中始终优于标准ITE，展现出超线性收敛和能量误差在有限虚时间内精确归零的两个阶段。

Conclusion: AITE通过利用高阶统计信息显著加速了虚时间演化，且标准ITE可视为其零偏度极限，表明该加速策略可自然推广至整个ITE算法家族。
...
### [64] [A Hybrid Quantum-Classical Approach for Melt Pool Prediction in Laser Powder Bed Fusion](https://arxiv.org/abs/2606.23719)
*Matthew M. Sato,Kincho H. Law*

Main category: quant-ph

TL;DR: 本文提出了一种混合量子-经典模型，利用量子计算增强激光粉末床熔融工艺中的特征提取，通过聚类减少量子计算开销，并结合经典神经网络预测熔池形貌，验证了在NISQ设备上实现工程应用的可行性。


<details>
  <summary>Details</summary>
Motivation: 由于激光粉末床熔融（LPBF）制造过程中物理机制复杂，传统方法难以准确根据工艺参数预测熔池形态，导致质量控制困难，因此需要新的计算手段提升预测能力。

Method: 采用聚类算法降低数据规模以减少量子计算成本，设计量子特征编码器提取关键特征，再由经典神经网络完成熔池形貌预测，并在量子模拟器和真实量子硬件上进行测试与验证。

Result: 所提混合模型相比纯经典网络具有更高的预测精度，验证了量子特征的有效性，同时分析了测量噪声对性能的影响，并识别出关键量子特征以指导未来量子电路设计。

Conclusion: 该研究证明了混合量子-经典模型在增材制造质量预测中的有效性，为在当前噪声中等规模量子设备上实现实际工程应用提供了可行路径。
...
### [65] [Quantum-enhanced estimation of stimulated Raman optical activity](https://arxiv.org/abs/2606.23722)
*Mahadeva Chanda Durjoy,Girish S. Agarwal*

Main category: quant-ph

TL;DR: 提出利用双模压缩真空实现亚散粒噪声极限的受激拉曼光学活性（ROA）测量，通过量子估计理论证明其可提高测量精度，适用于弱信号和光敏感样品的手性光谱检测。


<details>
  <summary>Details</summary>
Motivation: 传统ROA信号微弱，经典探测受限于散粒噪声，难以实现高精度测量，尤其对弱手性及光敏感样品。

Method: 采用双模压缩真空作为探测光源，结合量子估计理论计算量子费舍尔信息和量子Cramér-Rao界（QCRB），并分析平衡探测方案在小手性极限下的最优性。

Result: 双模压缩真空可通过光子数关联抑制强度波动，实现亚散粒噪声精度；平衡探测方案可接近QCRB，在小手性条件下达到最优测量性能。

Conclusion: 该方法为高灵敏度拉曼手性光谱学提供了可行路径，尤其适用于弱信号和光敏感生物样本与药物分子的无标记检测。
...
### [66] [Ultra-Low-Rate Information Reconciliation: Repetition Coding or Dedicated Codes?](https://arxiv.org/abs/2606.23726)
...
### [67] [Certifying Quantum Optimization and Circuit Cutting by Using Quantum-Classical Moment Duality](https://arxiv.org/abs/2606.23727)
*Ammar Daskin*
...
### [68] [Challenges in Barren Plateau Mitigation with Dynamic Parameterized Quantum Circuits](https://arxiv.org/abs/2606.23751)
...
### [69] [Connecting Quantum Tomography and Quantum Retrodiction](https://arxiv.org/abs/2606.23777)
...
### [70] [A no-go theorem for privacy in distributed sensing using Gaussian states](https://arxiv.org/abs/2606.23796)
...
### [71] [Unitary Designs from Doped Matchgate Circuits](https://arxiv.org/abs/2606.23800)
...
### [72] [Wavelet Matrix Product States for Quantum Fields](https://arxiv.org/abs/2606.23823)
...
### [73] [Infinite-Level Hierarchy of Solvable Quantum Circuits](https://arxiv.org/abs/2606.23803)
...
### [74] [Efficient Graph State Purification with Factorized Graph-Preserving Operations across Local Clifford Orbits](https://arxiv.org/abs/2606.23809)
...
### [75] [Revealing high-dimensional entanglement through symmetry](https://arxiv.org/abs/2606.23817)
...
### [76] [Initial-state-dependent dephasing effect in non-Hermitian Su-Schrieffer-Heeger models](https://arxiv.org/abs/2606.24185)
*Tao Min,Junjie Liu*
...
### [77] [Mode-selective nonlinear interference for high-brightness and high-purity fiber-coupled SPDC sources](https://arxiv.org/abs/2606.23836)
...
### [78] [When does dissipation help neural surrogates learn open quantum dynamics?](https://arxiv.org/abs/2606.23894)
*Alauddin Ahmed*
...
### [79] [Quantum-enabled active matter at the atomic scale](https://arxiv.org/abs/2606.24615)
...
### [80] [Mølmer-Sørensen gates in trapped-ions chains in the presence of correlated noise](https://arxiv.org/abs/2606.23951)
...
### [81] [Biophysical EPR Using Superconducting Resonators](https://arxiv.org/abs/2606.23952)
...
### [82] [Polynomial-time exact diagonalization via sparse guided eigenwalks](https://arxiv.org/abs/2606.23967)
...
### [83] [Suppressing Self-Discharging of Quantum Batteries by Cavity Interactions](https://arxiv.org/abs/2606.23999)
...
### [84] [Picosecond Schrödinger cat states for ultrafast optical quantum processing](https://arxiv.org/abs/2606.24002)
...
### [85] [Reachability and optimal-time certificates for quantum control](https://arxiv.org/abs/2606.24645)
...
### [86] [Spectrally engineered collinear type-0 SPDC source with enhanced spectral brightness for entanglement distribution](https://arxiv.org/abs/2606.24036)
...
### [87] [An Analysis of Speculative Window Decoders for Quantum Error Correction](https://arxiv.org/abs/2606.24048)
...
### [88] [Low Spatial Cost CCZ Magic State Factory](https://arxiv.org/abs/2606.24170)
...
### [89] [From Spectral Singularities to Multipartite Entanglement Scaling at Higher-Order Exceptional Points](https://arxiv.org/abs/2606.24205)
...
### [90] [Ground-State Energy Solutions of the Lithium Atom: Zeroth-, First-, and Second-Order Perturbation Theory and the Variational Method](https://arxiv.org/abs/2606.24238)
...
### [91] [Monitoring Beam Splitter Entanglement using Quantumness](https://arxiv.org/abs/2606.24242)
...
### [92] [Non-adiabatic transitions in the density matrix formalism](https://arxiv.org/abs/2606.24310)
...
### [93] [Wigner's Phase Space Current for Variable Beam Splitters -- Phase Space Rotations and Newtonian Trajectories](https://arxiv.org/abs/2606.24334)
...
### [94] [Multipartite synchronization residuals in driven-dissipative spin networks](https://arxiv.org/abs/2606.24360)
...
### [95] [Intrinsic spectral structure of bipartite nonlocal magic resource](https://arxiv.org/abs/2606.24368)
...
### [96] [Free-Space CV-QKD with Single-Mode Fiber Reception: Effective Coupling Statistics and Protocol-Dependent Reference Noise](https://arxiv.org/abs/2606.24431)
...
### [97] [Interaction-Enhanced Ergotropy in Phase-Driven Andreev Bound State Quantum Batteries](https://arxiv.org/abs/2606.24456)
...
### [98] [When to Skip Syndrome Extraction in Surface-GKP Codes](https://arxiv.org/abs/2606.24469)
...
### [99] [Exact log-depth preparation of highly entangled matrix product states](https://arxiv.org/abs/2606.24475)
...
### [100] [Uncovering Latent Structures in Robust Pulse Sequences: A Model-Based Reinforcement Learning Approach for Adaptable Quantum Control](https://arxiv.org/abs/2606.24507)
...
### [101] [How rare are Markovian quantum dynamics?](https://arxiv.org/abs/2606.24511)
...
### [102] [No-deleting principle for two unitary copies](https://arxiv.org/abs/2606.24522)
*Dafa Li*
...
### [103] [Offline Channel-Independent QAOA Angles for RIS Power Aggregation: Unit-Circle Phase Dictionaries and Infinite-Size Spin-Glass Limits](https://arxiv.org/abs/2606.24540)
*Burhan Gulbahar*
...
### [104] [Electrical-Circuit Simulation of the Uhlmann Phase](https://arxiv.org/abs/2606.24559)
...
### [105] [The Vector and Canonical Components of the Momentum Operator in 3D Euclidean Space Spanned by General Curvilinear Coordinates](https://arxiv.org/abs/2606.24572)
*M. S. Shikakhwa*
...
### [106] [Auxiliary Schmidt Rank as a Resource for Photonic Bell Measurements](https://arxiv.org/abs/2606.24591)
...
### [107] [Preparing multi-qudit states in a definite-weight subspace](https://arxiv.org/abs/2606.24659)
...
### [108] [A Universal All-Fiber Quantum Buffer for the Telecom Band](https://arxiv.org/abs/2606.24681)
...
### [109] [Exceptional by Design: Long-Range Hopping as a Knob for Exceptional Point Control](https://arxiv.org/abs/2606.24705)
...
### [110] [Rotational Vacuum Friction of Nonabsorbing Particles](https://arxiv.org/abs/2606.24723)
...
### [111] [On the Limits of Stretching Quantum Pseudorandomness](https://arxiv.org/abs/2606.24736)
...
### [112] [Asymptotic Compression of Interactive Quantum Communication using Type-Constrained de Finetti Reduction](https://arxiv.org/abs/2606.24746)
...
### [113] [A high-fidelity two-qubit gate for multimode superconducting P-mon qubits](https://arxiv.org/abs/2606.24772)
...
### [114] [Faster algorithm for achieving minimal-size quantum decision diagrams](https://arxiv.org/abs/2606.24789)
...
### [115] [Compressed Quantum Operators and Roots of Hermite Polynomials](https://arxiv.org/abs/2606.24792)
...
### [116] [Anomalous weak values in a generalized Mach-Zehnder interferometer extracted directly from intensity measurements](https://arxiv.org/abs/2606.24798)
...
### [117] [Large-Language-Model Discovery of Quantum LDPC Codes through Structured Concept Evolution](https://arxiv.org/abs/2606.24808)
...
### [118] [Rapid Cavity-Based Mid-Circuit Measurement and Feedforward in a Neutral Atom Array](https://arxiv.org/abs/2606.24869)
...
### [119] [From stable online coupling to decade-long climate simulations: A machine learning parameterization for cloud microphysics in ICON](https://arxiv.org/abs/2606.23829)
*Ellen Sarauer,Mierk Schwabe,Philipp Weiss,Axel Lauer,Philip Stier,Veronika Eyring*

Main category: physics.ao-ph

TL;DR: 本研究开发并在线耦合了一个基于机器学习的云微物理参数化方案到ICON模式中，实现了长达十年的稳定气候模拟，表明基于机器学习的云微物理方案在地球系统模型中的可行性。


<details>
  <summary>Details</summary>
Motivation: 云微物理的非线性及尺度依赖性是地球系统模型中的主要不确定性来源，传统参数化方案存在局限，需探索更优的替代方法。

Method: 使用5公里分辨率的全球对流解析模拟数据训练一个两阶段机器学习模型（分类器识别活跃网格，回归器预测微物理趋势），并在ICON模式中实现在线耦合，引入物理约束以确保数值稳定性。

Result: 该机器学习方案在长达十年的模拟中保持数值稳定，气候再现能力与传统冰雹方案相当，消除了两个依赖调参的参数，但尚未显著改善长期平均态偏差。

Conclusion: 基于机器学习的云微物理方案可实现长期稳定的气候模拟，为未来混合型地球系统模型的发展奠定了基础。
...
### [120] [Why is Seasonal Climate Predictable Beyond the Limit of Deterministic Predictability set by Chaos?](https://arxiv.org/abs/2606.24358)
*Vladimir García-Morales,Devabrat Sharma,Shruti Tandon,B. N. Goswami,R. I. Sujith*

Main category: physics.ao-ph

TL;DR: 研究表明，印度夏季风降雨（ISMR）的可预测性可达18个月，远超其确定性预测极限，这是由于ISMR与其强耦合的全球厄尔尼诺-南方涛动（G-ENSO）之间存在滞后同步所致。


<details>
  <summary>Details</summary>
Motivation: 探索超出传统确定性预测极限的气候系统长期可预测性的物理机制。

Method: 构建两个相互作用的振荡介质模型，使用复数序参量描述系统内部动力学，并通过耦合的复Ginzburg-Landau方程模拟其时空演化。

Result: 发现ISMR与G-ENSO之间的滞后同步导致了长达18个月的强相关时间序列，从而实现超越LDP的预测能力。

Conclusion: 滞后同步是提升季节性气候预测能力的关键机制，具有推广到其他气候系统的潜力。
...
### [121] [An observationally constrained probabilistic trigger for organized deep convection in an NWP ensemble](https://arxiv.org/abs/2606.24563)
...
### [122] [One-Loop Renormalization of the Improved Energy-Momentum Tensor in Lattice QCD](https://arxiv.org/abs/2606.24222)
*Mushtaq Loan,Nasser Demir*

Main category: hep-lat

TL;DR: 本文在一圈重整化分析中研究了纯SU(3)格点规范理论中改进的胶子能量-动量张量，采用 tadpole 改进的树层级 Symanzik 规范作用量和三圈改进的 clover 离散化方法。通过匹配格点与连续 MSbar 方案，得到了有限格点系数和乘法重整化因子，并明确区分了自旋-2 部分与标量迹部分，验证了其在连续极限下正确再现杨-米尔斯迹异常结构。


<details>
  <summary>Details</summary>
Motivation: 旨在构建一个能正确再现连续极限下能量-动量张量对称性和异常结构的格点算符，用于精确计算量子色动力学中的能量密度关联函数、状态方程和输运系数。

Method: 采用 tadpole 改进的 Symanzik 规范作用量和三圈改进的 clover 离散化，在 Landau 规范下通过一圈微扰论计算两胶子矩阵元，并将其从格点匹配到连续 MSbar 方案，分离出 sail、operator-tadpole 和外腿修正项。

Result: 得到了有限系数 B_lat(u0) 和重整化因子 Z_T(u0) 的显式表达式；明确了自旋-2 部分由 Z_T 控制，而迹部分由 F² 算符和 β 函数决定；改进后的算符能准确重现已知的迹异常温度依赖行为。

Conclusion: 改进的格点能量-动量张量能正确保持连续极限下的对称性与异常结构，为格点QCD中热力学量、胶子凝聚和输运系数的系统性高精度研究提供了可靠框架。
...
### [123] [Universal Dynamical Response to Slow Driving in Chaotic Systems](https://arxiv.org/abs/2606.23810)
*Nachiket Karve,Nathan Rose,David Campbell,Anatoli Polkovnikov*

Main category: cond-mat.stat-mech

TL;DR: 提出了一种基于系统在慢驱动下稳态稳定性的经典与量子混沌的统一视角，通过“速度-费舍尔信息”来探测系统对平均协议速度的敏感性，并将其与不可逆熵产生联系起来。


<details>
  <summary>Details</summary>
Motivation: 旨在建立一个能够同时适用于经典和量子系统的混沌统一理论框架，通过动力学稳定性来刻画混沌行为。

Method: 引入‘速度-费舍尔信息’作为探测量，分析系统在慢驱动下的响应，并将其与扰动的低频谱权重及不可逆熵产生关联。

Result: 发现混沌动力学会导致速度-费舍尔信息随协议时间发散，且该响应由扰动的低频谱权重控制；该方法适用于哈密顿与非哈密顿系统。

Conclusion: 提供了一个统一的、跨经典与量子体系的混沌分析框架，揭示了低频谱特性在决定系统对慢驱动敏感性中的关键作用。
...
### [124] [Pareto-optimal control strategies in intrinsically nonequilibrium systems](https://arxiv.org/abs/2606.23828)
*Gustavo A. L. Forão,Carlos E. Fiore,Jonas Berx*

Main category: cond-mat.stat-mech

TL;DR: 提出了一种多目标热力学控制框架，用于刻画非平衡系统的帕累托前沿，并揭示了最优协议的普适结构和控制等价类。


<details>
  <summary>Details</summary>
Motivation: 单目标优化无法描述多个竞争代价下的性能权衡，因此需要发展多目标热力学控制理论以全面刻画非平衡系统的最优控制策略。

Method: 构建了一个适用于非平衡系统的多目标热力学控制通用框架，通过分析帕累托最优协议的结构，发现其由光滑段和边界跳跃组成，并引入一个融合目标权重与物理参数的内在尺度来统一描述权衡行为。

Result: 发现该内在尺度不仅参数化整个帕累托前沿的函数形式，还定义了控制等价类；在活性粒子捕获和量子点热机两个实验可实现系统中，均得到了帕累托前沿和最优策略的解析解。

Conclusion: 所提出的框架为多目标热力学控制提供了统一视角，揭示了非平衡系统中最优策略的普适规律，并可通过单一尺度参数进行分类和预测。
...
### [125] [Out-of-equilibrium scaling of the particle density in quantum fermionic wires after a critical quenching of the chemical potential](https://arxiv.org/abs/2606.24395)
*H. Panagopoulos,E. Vicari*

Main category: cond-mat.stat-mech

TL;DR: 研究了Kitaev导线中在化学势的瞬时量子淬火后粒子密度的非平衡态标度行为，发现其表现出与初始状态长度尺度和动态临界指数相关的普适动态标度规律。


<details>
  <summary>Details</summary>
Motivation: 探究量子淬火后非平衡态下粒子密度的标度行为，特别是其在临界点附近的动力学演化特性，以理解与平衡态不同的普适性规律。

Method: 通过解析方法分析在化学势突然淬火至临界点后的粒子密度演化，基于动态标度变量θ ~ t/ξ^z构建标度理论，并对比数值有限尺寸标度分析结果。

Result: 发现淬火后粒子密度与临界值之差呈现出由动态标度变量θ控制的非平衡标度行为，且标度函数在θ→0时表现出奇异性，反映了起始点处平衡态标度的异常特性。

Conclusion: 提供了淬火后减去背景的粒子密度存在普适动态标度行为的解析证据，表明该现象超越非普适平衡贡献，支持此前关于非平衡标度普适性的猜想。
...
### [126] [Two-Dimensional Phase Transitions in Classical Systems: 60 Years after the Hohenberg-Mermin-Wagner Theorem](https://arxiv.org/abs/2606.24091)
*Ruijian Zhu,Yanting Wang*

Main category: cond-mat.stat-mech

TL;DR: 本文综述了二维系统中熔化问题的最新理论和计算进展，重点讨论了被动系统中的BKT理论及其在非平衡活性物质系统中的扩展应用。


<details>
  <summary>Details</summary>
Motivation: 二维系统中连续对称性长程有序的破坏机制以及非平衡态下活性物质的新现象尚未完全理解，需要系统总结和进一步研究。

Method: 通过回顾近年来在被动和非平衡二维系统中的理论发展和计算模拟结果，分析BKT相变机制及拓扑缺陷行为。

Result: 总结了二维晶体熔化的当前理解，并揭示了活性物质中偏离传统Hohenberg-Mermin-Wagner定理的新现象。

Conclusion: BKT理论在二维熔化中具有核心地位，未来的研究应聚焦于预测熔化情景和理解非平衡活性物质的本质特征。
...
### [127] [Evaluating the solution performance of the augmented Lagrangian function on Ising machines](https://arxiv.org/abs/2606.24241)
...
### [128] [Universal Extraction of Quantum Critical Exponents and Phase Transitions via Tailored Hilbert Space](https://arxiv.org/abs/2606.24312)
*Ye Xiong*
...
### [129] [Exact log-odds representation and mean-field criticality of a growing social group model](https://arxiv.org/abs/2606.24818)
...
### [130] [The impact of population heterogeneity on the redundancy principle](https://arxiv.org/abs/2606.24411)
...
### [131] [From Continuous-Time Random Walks to Laplace Tails](https://arxiv.org/abs/2606.24451)
...
### [132] [Anomalous Floquet Heating from Sparse Long-Range Interactions](https://arxiv.org/abs/2606.24541)
...
### [133] [First-Order Recoverability Collapse in Self-Referential Information Decoders](https://arxiv.org/abs/2606.24861)
*Pieter van Rooyen*
...
### [134] [Exact vs approximate second-order derivatives in vertically-integrated ice sheet models](https://arxiv.org/abs/2606.23691)
*Trystan Surawy-Stepney,Stephen L. Cornford*

Main category: math.NA

TL;DR: 本文提出了一种用于浅流近似模型的二阶伴随模型，用于计算冰盖建模中的近似二阶导数，并与基于算法微分（AD）的全二阶导数进行比较，发现近似Hessian矩阵在前4个主模态后其特征子空间开始偏离，因此其适用性依赖于具体应用场景。


<details>
  <summary>Details</summary>
Motivation: 冰盖模型中需要高效计算输出对输入参数的二阶导数以支持优化和不确定性量化，但许多主流模型不支持算法微分（AD），因此需要构建近似的二阶伴随模型。

Method: 构建基于PDE层面的近似二阶伴随模型（忽略冰粘度对速度的非线性依赖），用于浅流近似方程，并计算Hessian-向量乘积，随后与采用算法微分得到的全二阶导数结果进行谱分解对比。

Result: 近似Hessian-向量乘积与AD计算的结果表面相似，但Hessian矩阵的谱分解显示其特征向量张成的子空间在前4个主导模态后开始偏离，尽管偏离速度未加快。

Conclusion: 该近似Hessian的实用性取决于具体应用；当需要高保真度或高于极低秩的精度时，应使用通过AD计算的完整Hessian。
...
### [135] [Ten Digits on a Train: AI-Assisted Verification of Two Eigenvalue Problems](https://arxiv.org/abs/2606.23821)
*Matthew J. Colbrook*

Main category: math.NA

TL;DR: 本论文通过人机协作，利用验证计算方法解决了两类难以精确求解的算子特征值问题：奇异自伴薛定谔算子的负谱和非正规原子-分子共振态，提出了一种可重用的认证计算架构，并探讨了AI在数学证明中的作用与局限。


<details>
  <summary>Details</summary>
Motivation: 准确的数值特征值在奇异或非正规情形下难以被严格认证，现有方法如单向打靶法存在精度不足或无法提供严格证明的问题，亟需新的认证策略以提升可靠性和普适性。

Method: 对于奇异自伴情形，采用验证零点计数与狄利克雷-诺伊曼夹逼法；对于非正规系统，则将问题重构为基于投影解线的全局匹配系统，通过组件式、尾部鲁棒的Krawczyk-Brouwer包含法对不确定渐近数据进行编码并实现严格认证。

Result: 成功以十位小数精度完整认证了奇异薛定谔算子的全部负谱，并分离且精确包围了一个此前未解决的非正规共振态对；提出的方法具备处理传播病态和渐近不确定性问题的通用潜力。

Conclusion: AI可快速生成候选解与证明思路，但关键验证步骤仍依赖人类判断，尤其是严格证明对象（如组件式检查）不可或缺；验证计算是检验AI辅助数学研究的严苛标准，未来需重新思考验证、评审与训练的标准以应对AI带来的变革。
...
### [136] [Diagonal Frog: High-order positivity-preserving FD schemes for anisotropic Fokker-Planck equations](https://arxiv.org/abs/2606.23980)
*Andrey Itkin*

Main category: math.NA

TL;DR: 本文提出了一类名为“对角蛙”（Diagonal Frog）的离散化方法，用于求解具有多变量、各向异性扩散和跳跃过程的Fokker-Planck方程，确保概率密度非负且质量守恒。


<details>
  <summary>Details</summary>
Motivation: 传统离散化方法在处理多变量、各向异性交叉扩散和跳跃过程时，常产生非物理的负概率密度，因此需要一种能保持概率正定性的数值方法。

Method: 基于Itkin的算子方法，构建一类空间算子为最终M矩阵（EM-matrix）的‘对角蛙’离散格式；利用矩阵指数的极限结构保证非负性，并采用分裂步长法结合预解因子化求解器处理混合导数项，实现质量和正定性守恒。

Result: 该方法在时间与空间上均为二阶精度，每步计算复杂度为O(m^2N + m^3)；通过多个压力测试（如强交叉扩散、双势阱逃逸、对流主导问题）验证了其稳定性、非负性和质量守恒性，适用于广泛佩克莱特数范围，无需通量限制器；并可推广至多维过程与带跳跃的后向Kolmogorov方程。

Conclusion: 所提出的‘对角蛙’离散方法有效解决了Fokker-Planck方程在复杂条件下的数值失真问题，能够在不引入非物理解的情况下保持概率密度的正定性和系统质量守恒，具有良好的稳定性和扩展性。
...
### [137] [Variational inference and density estimation with non-negative tensor of hierarchical tucker format](https://arxiv.org/abs/2606.23949)
*Xun Tang,Haoxuan Chen,Lexing Ying*

Main category: math.NA

TL;DR: 提出了一种高效压缩高维离散概率函数（即概率张量）为非负分层Tucker格式的方法，分为两个阶段：第一阶段使用插值方法将张量压缩为分层Tucker格式，第二阶段通过特定的二阶方法拟合非负分层Tucker结构。该方法在张量阶数为d时具有O(d)计算复杂度，适用于高维场景，并在数值实验中成功压缩了多种高维概率张量。


<details>
  <summary>Details</summary>
Motivation: 为了高效处理高维离散概率函数的存储和计算问题，需要一种可扩展至高维的张量压缩方法。

Method: 采用两阶段方法：第一阶段利用类似CUR分解的插值技术将目标张量压缩为分层Tucker格式；第二阶段使用专为此设置设计的二阶优化方法将其拟合到非负分层Tucker形式。

Result: 该方法在张量阶数为d时具有O(d)的计算复杂度，能够在高维设置下高效运行，并在多个高维概率张量上验证了压缩效果。

Conclusion: 所提方法能够有效压缩高维概率张量，具备良好的可扩展性和实用性，适合应用于高维数据建模与分析。
...
### [138] [Dynamical low-rank methods for the Wigner equation I: separable difference potential](https://arxiv.org/abs/2606.24190)
*Sihong Shao,Yuehan Shao*

Main category: math.NA

TL;DR: 提出了一种用于求解Wigner方程的高效动态低秩近似（DLRA）算法，通过差分势的可分离分解及Ψ算子的两种截断方式实现分离表示，在多种复杂系统中显著降低了计算时间和内存需求。


<details>
  <summary>Details</summary>
Motivation: 现有DLRA算法在处理包含复杂碰撞项（如Wigner方程中的非局域伪微分算子Ψ）的系统时仍面临挑战，亟需发展适用于此类高维问题的DLRA方法。

Method: 采用差分势的可分离分解假设，并结合Ψ算子的K-截断和Y-截断，构建其分离表示形式，进而设计高效的DLRA算法。

Result: 在满足可分离假设的多个挑战性实验中（如谐振子、高斯势垒散射、电子-电子碰撞和类氦系统），新算法相比全网格方法在运行时间和内存消耗上均减少一到两个数量级。

Conclusion: 即使解本身没有预设的低秩结构，该DLRA算法仍能作为一种兼顾效率与精度的数值方案，为后续研究Wigner方程及其他非局域问题的低秩算法奠定了基础。
...
### [139] [Computing the minimal monomial basis for multivariate Birkhoff interpolation](https://arxiv.org/abs/2606.24054)
...
### [140] [E Scheme and Flux-Limiter Scheme, Revisited](https://arxiv.org/abs/2606.24186)
*Huazhong Tang*
...
### [141] [Tractability versus curse of dimensionality for geometric $L_p$-discrepancies](https://arxiv.org/abs/2606.24195)
...
### [142] [Quasi-Monte Carlo for SDE Simulation: Error Analysis and Dimensionality Reduction](https://arxiv.org/abs/2606.24207)
...
### [143] [Deep numerical schemes for systems of Ergodic BSDEs with applications to regime-switching forward utilities](https://arxiv.org/abs/2606.24271)
...
### [144] [The 3D Nonconforming Virtual Element Method with enhanced spaces: numerical investigation and implementation guide](https://arxiv.org/abs/2606.24306)
...
### [145] [A sparse spectral method on a class of domains bounded by planar algebraic curves](https://arxiv.org/abs/2606.24423)
...
### [146] [Randomized Estimation of T-Eigenvalues of T-SPD Tensors: A Two-Sided Bracket](https://arxiv.org/abs/2606.24491)
...
### [147] [Certified Reachable Sets for Nonlinear Reaction--Diffusion Systems](https://arxiv.org/abs/2606.24500)
...
### [148] [Analysis and approximation of a two-dimensional induction heating problem](https://arxiv.org/abs/2606.24517)
...
### [149] [The lymph 2.0 library: p-adaptive algorithms and parallel assembly strategies for polytopal DG methods](https://arxiv.org/abs/2606.24646)
...
### [150] [Recursive expansion of the matrix step function using polynomials of degree eight](https://arxiv.org/abs/2606.24701)
...
### [151] [Dirac-Frenkel dynamics with inertia for nonlinearly parametrized solutions of evolution problems](https://arxiv.org/abs/2606.24769)
...
### [152] [LAMG+: A Robust Lean Algebraic Multigrid Solver for Graph Laplacians](https://arxiv.org/abs/2606.24791)
*Oren E. Livne*
...
### [153] [Sharp Sobolev Sandwich and Approximation Rates of Radon-Domain $L^p$ Ridge Integral Spaces for ReLU$^k$ Networks](https://arxiv.org/abs/2606.24795)
...
### [154] [The Effect of Quadrature on the Convergence of Policy Iteration for Hamilton-Jacobi-Bellman Equations](https://arxiv.org/abs/2606.24806)
...
### [155] [Randomized Neural Networks for estimation of exposure profiles and Credit Valuation Adjustment (CVA) for American Equity Options](https://arxiv.org/abs/2606.24309)
*Isidro Moroso Varona,Jakub Michańków,Paweł Sakowski*

Main category: q-fin.CP

TL;DR: 本论文研究了在蒙特卡洛框架下使用随机神经网络估计美式期权的暴露分布和单边CVA，分别在Black-Scholes和Heston模型下进行分析，并与传统的最小二乘蒙特卡洛（LSM）方法对比，结果显示随机神经网络在高维问题中具有更高的计算效率和可扩展性。


<details>
  <summary>Details</summary>
Motivation: 传统LSM方法在高维情形下计算成本高且难以扩展，因此需要一种更高效的替代方法来准确估计美式期权的暴露和CVA。

Method: 采用随机前馈神经网络，在Black-Scholes和Heston动态模型下，结合美式期权定价、预期暴露、潜在未来暴露估计以及包含净额结算的单边CVA计算，通过蒙特卡洛模拟进行数值实验，并与LSM基准方法比较，同时进行路径收敛性测试和敏感性分析。

Result: 随机神经网络方法在低维和高维场景下均能收敛至LSM基准结果，在高维多资产情况下展现出更优的可扩展性和更低的计算成本。

Conclusion: 随机神经网络是估计高维美式期权暴露和CVA的有效且具优势的替代方法，尤其适用于传统方法难以处理的复杂高维金融衍生品风险评估。
...
### [156] [Sphere of Influence Centrality via Shapley Values: Empirical Approximation and Network Coverage Analysis](https://arxiv.org/abs/2606.24121)
*Sie Hendrata Dharmawan,Kevin Limanta,Brendan Liu,Peter Chin*

Main category: cs.SI

TL;DR: 本文系统评估了基于Shapley值的影响力范围选择框架，使用Michalak等人提出的精确多项式时间算法，在三种可达性标准下选出m个节点以最大化网络覆盖。实验结果表明，实际近似比接近0.9，显著超过理论下限(1-1/e)，且在枢纽-辐射型拓扑中明显优于基于度的基线方法。


<details>
  <summary>Details</summary>
Motivation: 传统节点中心性指标未能捕捉影响的集体性和合作性本质，因此需要一种更合理的衡量方式来识别最具影响力的节点集合。

Method: 采用基于Shapley值的博弈论方法，结合单跳、k跳和多路径连通性三种准则，利用Michalak等人提出的精确多项式时间算法计算节点的贡献值，并进行实证评估。

Result: 在Euroroad、Facebook TV Shows和Cora三个真实网络上的实验显示，实际近似比持续接近0.9，远高于理论下界(1-1/e)；Shapley值方法显著优于基于度的基线方法。例如，在Cora网络中仅需26个节点（不足1%）即可通过3跳影响一半节点，而基线方法需要更大规模的节点集。

Conclusion: 基于Shapley值的方法能高效识别关键影响节点，尤其适用于枢纽-辐射型网络结构，其实际性能优于理论预期和传统启发式方法。
...
### [157] [SBM With Multiple Samples: Improved Spectral Recovery](https://arxiv.org/abs/2606.24141)
*Sie Hendrata Dharmawan,Peter Chin*

Main category: cs.SI

TL;DR: 本文研究了在具有多个独立图样本的双块随机块模型中进行社区检测的问题，提出通过平均多个样本并使用谱聚类方法可显著提升社区发现的准确性，理论和实验结果均验证了该方法的有效性。


<details>
  <summary>Details</summary>
Motivation: 在现实场景中，图数据往往具有噪声且单一图样本难以准确揭示社区结构，因此需要利用多个独立图样本来提高社区检测的鲁棒性和精度。

Method: 基于一种保持邻接矩阵元素独立性的简化谱算法，通过对m个独立图样本取平均后应用谱划分方法，并结合对噪声矩阵的多样本谱范数界分析，推导出误差界随样本数指数级下降的理论保证。

Result: 理论表明，当满足\frac{(a-b)^2}{a+b} \geq \frac{C}{m} \log \frac{2}{γ}时，能以1-o(1)概率找到γ-正确划分，相比单样本情况所需条件放宽了m倍；实验验证了该界是紧致的，即使2-3个样本也能显著提升恢复精度。

Conclusion: 多图样本平均结合谱聚类能有效提升社区检测性能，为现代图表示学习中的图数据增强策略提供了严谨的理论基础。
...
### [158] [Discovery of connectivity-trainability trade-off of IQP Circuits for Hamiltonian Optimization](https://arxiv.org/abs/2606.24264)
*Quoc Chuong Nguyen*

Main category: cs.SI

TL;DR: 本文研究了IQP电路在哈密顿优化中的性能与可训练性，发现电路结构在实现低能态方面起关键作用，并揭示了优化性能与电路连通性之间的权衡。


<details>
  <summary>Details</summary>
Motivation: 探索IQP电路在优化任务中的潜力，尤其是在近似量子优势背景下其除采样外的应用能力。

Method: 系统分析不同连接结构的IQP电路在哈密顿优化中的表现和训练特性。

Result: 发现优化性能与电路连通性之间存在权衡，电路结构显著影响达到低能态的能力。

Conclusion: IQP电路的结构设计对其在优化任务中的有效性至关重要，为未来量子优化算法的设计提供了指导。
...
### [159] [Bias-Aware Confidence Intervals for Synthetic Control via Placebo-in-Time Bootstrap](https://arxiv.org/abs/2606.23857)
*Song Wei,Sonia Park,Niteesh Kalangi,Jason Huang*

Main category: stat.ME

TL;DR: 提出一种基于“时间安慰剂”自助法的合成控制效应置信区间方法，直接估计系统性偏差分布，解决传统高斯置信区间在偏差存在下的误导向问题。


<details>
  <summary>Details</summary>
Motivation: 传统的合成控制方法在处理强度较低的群体时，系统性偏差可能超过信号本身，导致标准置信区间误导向；现有方法无法衡量这种偏差，需要更可靠的推断工具。

Method: 采用“时间安慰剂”自助法：将处理时点回溯，在多个虚拟时点重新拟合合成控制模型，利用生成的安慰剂差距估计偏差分布，并通过自助抽样获得零假设下的临界值。

Result: 该方法能直接估计合成控制估计量中的系统性偏差，提供更准确的置信区间；由于重采样的是实际模型误差而非假设效应，覆盖概率不依赖于真实效应的时间轨迹，具有路径无关性。

Conclusion: 所提出的安慰剂-in-time自助法能够有效校正合成控制方法中的系统性偏差，避免传统置信区间的误导向问题，为因果推断提供了更稳健、可靠的小样本推断工具。
...
### [160] [Empirical prior distributions for treatment-by-subgroup interaction heterogeneity in random-effects meta-analysis](https://arxiv.org/abs/2606.23968)
*Renato Panaro,Christian Röver,Tim Friede*

Main category: stat.ME

TL;DR: 本文通过分析Cochrane系统综述数据库中的3000多个交互作用荟萃分析，提出了针对治疗-亚组交互效应异质性的经验先验分布，发现交互效应的异质性通常显著小于总体治疗效应的异质性，并强调在稀疏数据下使用特定先验可提高估计精度。


<details>
  <summary>Details</summary>
Motivation: 由于现有研究中缺乏对治疗-亚组交互效应异质性的实证校准，而在少数研究情况下推断交互效应需要合理考虑异质性，因此有必要基于大量实证数据建立可用于贝叶斯分析的经验先验分布。

Method: 从Cochrane系统综述数据库中提取超过3000个交互作用荟萃分析，分别估计总体治疗效应和交互效应的异质性（τ），并据此构建效应度量特异性的预测先验分布，比较两类异质性的大小，并探讨其在贝叶斯推断中的应用价值。

Result: 交互效应的异质性普遍显著小于总体治疗效应的异质性；由于交互估计的精度较低，异质性更难识别；使用针对交互效应的经验先验可在稀疏荟萃分析中显著提升估计精度。

Conclusion: 为治疗-亚组交互效应提供经过实证校准的先验分布有助于改善贝叶斯荟萃分析的推断质量，特别是在可用研究数量有限的情况下，推荐使用效应度量特异且针对交互作用定制的先验。
...
### [161] [Inference and local influence diagnostics for unit-Lindley additive partially linear models](https://arxiv.org/abs/2606.23972)
*Hatice T. K. Akdur,Danilo V. Silva,Gilberto A. Paula*

Main category: stat.ME

TL;DR: 本文提出了一种新的回归框架——单位Lindley可加部分线性模型（UL-APLMs），用于建模限制在单位区间内的响应变量，结合了参数简洁性与结构灵活性，并通过实际心理数据展示了其应用价值。


<details>
  <summary>Details</summary>
Motivation: 为了解决单位区间内响应变量的建模问题，现有模型在解释性和灵活性之间难以平衡，因此需要一种兼具 parsimony 和灵活结构的新方法。

Method: 提出单位Lindley可加部分线性模型（UL-APLMs），使用B样条基函数和惩罚似然框架对可加项进行建模，并通过最大化惩罚对数似然函数实现参数估计；采用残差分析评估拟合优度，利用局部影响法（包括病例权重和响应扰动）进行敏感性分析。

Result: 推导出敏感性矩阵和惩罚观测信息矩阵；模拟研究表明该估计方法在多种情景下具有高准确性；在垂体功能减退患者心理特征的实际数据分析中验证了模型的有效性和诊断价值。

Conclusion: UL-APLMs模型在保持解释性的同时提供了良好的建模灵活性，适用于单位区间响应变量的分析，具备稳健的参数估计能力和诊断性能，具有实际应用前景。
...
### [162] [Inferential applications of the moments of the logit-normal distribution](https://arxiv.org/abs/2606.23998)
...
### [163] [Bayesian Mixture Models for Histograms: with Applications to Large Datasets](https://arxiv.org/abs/2606.24001)
...
### [164] [Pseudo-value Based Mean Cumulative Count Regression](https://arxiv.org/abs/2606.24024)
...
### [165] [A Non-Stationary Spatio-Temporal Covariance Model with Dynamic Advection Effects for Rainfall Data](https://arxiv.org/abs/2606.24076)
...
### [166] [Confounding analysis of s-level designs with multi-block variables](https://arxiv.org/abs/2606.24116)
*Wenbo Hu,Zhiming Li*
...
### [167] [Bayesian Variable Selection in Generalized Linear Models](https://arxiv.org/abs/2606.24357)
...
### [168] [Uncertainty intervals for multilevel models with missing not at random data](https://arxiv.org/abs/2606.24228)
*Minna Genbäck*
...
### [169] [When Surveys Become Conversations: Adaptive Matrix Validation for AI-Assisted Interviews](https://arxiv.org/abs/2606.24244)
*Tyler H. McCormick*
...
### [170] [Prediction of spatio-temporal data on meshed surfaces using advection-diffusion SPDEs](https://arxiv.org/abs/2606.24300)
...
### [171] [ICSpyLab: A Python package for invariant coordinate selection](https://arxiv.org/abs/2606.24521)
*Colombe Becquart*
...
### [172] [Partial Wavelet Canonical Coherence for Nonstationary Signals with High Dimensional Confounders](https://arxiv.org/abs/2606.24554)
...
### [173] [Bayesian Estimation of the Eigenstructure in High-Dimensional Approximate Factor Models](https://arxiv.org/abs/2606.24652)
...
### [174] [Landmarking with Latent Class Mixed Models for Dynamic Prediction of Time-to-event Data with Heterogeneous Biomarker Trajectories](https://arxiv.org/abs/2606.24678)
...
### [175] [Hierarchical Bayesian Estimation of Covariance Matrices](https://arxiv.org/abs/2606.24751)
...
### [176] [Sequential Probability Ratio Test using Z-Statistics (SPRT-z): A Practical Approach for Online Experimentation](https://arxiv.org/abs/2606.24871)
